module ParamsToArgsHelper
  ...
  def self.get_most_social_to_args(args)
    data = get_most_social_worker(args[:snapshot_id], args[:network_id], args[:pid], args[:gid])
  ...
  def self.get_friends_relation_in_network_to_args(args)
    data = get_friends_relation_in_network(args[:snapshot_id], args[:network_id], args[:pid], args[:gid], 'in')
    if args[:algorithm_type] == MEASURE
      return ParamsToArgsHelper.calculate_per_snapshot_and_pin(data, args[:snapshot_id], args[:pid], args[:gid])
    elsif args[:algorithm_type] == ANALYZE
      return ParamsToArgsHelper.questionnaire_based_analyze_for_precalculation(data, args[:company_id], args[:pid], args[:gid])
  ...
  def self.get_friends_out_network_to_args(args)
    res = get_friends_relation_in_network(args[:snapshot_id], args[:network_id], args[:pid], args[:gid], 'out')
    if args[:algorithm_type] == MEASURE
      return ParamsToArgsHelper.calculate_per_snapshot_and_pin(res, args[:snapshot_id], args[:pid], args[:gid])
    elsif args[:algorithm_type] == ANALYZE
      return ParamsToArgsHelper.questionnaire_based_analyze_for_precalculation(res, args[:company_id], args[:pid], args[:gid])
    end
  end
  ...
  def self.get_advice_out_network_to_args(args)
    res = get_advice_relation_in_network(args[:snapshot_id], args[:network_id], args[:pid], args[:gid], 'out')
    if args[:algorithm_type] == MEASURE
      return ParamsToArgsHelper.calculate_per_snapshot_and_pin(res, args[:snapshot_id], args[:pid], args[:gid])
    elsif args[:algorithm_type] == ANALYZE
      return ParamsToArgsHelper.questionnaire_based_analyze_for_precalculation(res, args[:company_id], args[:pid], args[:gid])
  ...
  def self.most_promising_worker_to_args(args)
    res = most_promising_worker(args[:company_id], args[:snapshot_id], args[:network_id], args[:network_b_id], args[:pid], args[:gid])
    return ParamsToArgsHelper.calculate_flags(res)
  end
  ...
  def self.team_glue_to_args(args)
    res = team_glue_algorithm(args[:company_id], args[:snapshot_id], args[:network_id], args[:pid], args[:gid])
    return ParamsToArgsHelper.calculate_flags(res)
  end

  def self.get_trust_in_network_to_args(args)
    data = get_trust_in_network(args[:snapshot_id], args[:network_id], args[:pid], args[:gid])
    if args[:algorithm_type] == MEASURE
      return ParamsToArgsHelper.calculate_per_snapshot_and_pin(data, args[:snapshot_id], args[:pid], args[:gid])
    elsif args[:algorithm_type] == ANALYZE
      return ParamsToArgsHelper.questionnaire_based_analyze_for_precalculation(data, args[:company_id], args[:pid], args[:gid])
  ...
  def self.get_trust_out_network_to_args(args)
    data = get_trust_out_network(args[:snapshot_id], args[:network_id], args[:pid], args[:gid])
    if args[:algorithm_type] == MEASURE
      return ParamsToArgsHelper.calculate_per_snapshot_and_pin(data, args[:snapshot_id], args[:pid], args[:gid])
    elsif args[:algorithm_type] == ANALYZE
      return ParamsToArgsHelper.questionnaire_based_analyze_for_precalculation(data, args[:company_id], args[:pid], args[:gid])
  ...
  def self.centrality_to_args(args)
    data = centrality_algorithm(args[:snapshot_id], args[:gid], args[:pid])
    if args[:algorithm_type] == MEASURE
      return ParamsToArgsHelper.calculate_per_snapshot_and_pin(data, args[:snapshot_id], args[:pid], args[:gid])
    elsif args[:algorithm_type] == ANALYZE
      ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id], args[:pid], args[:gid])
    end
  end

  def self.central_to_args(args)
    data = central_algorithm(args[:snapshot_id], args[:gid], args[:pid])
    if args[:algorithm_type] == MEASURE
      return ParamsToArgsHelper.calculate_per_snapshot_and_pin(data, args[:snapshot_id], args[:pid], args[:gid])
    elsif args[:algorithm_type] == ANALYZE
      ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id], args[:pid], args[:gid])
  ...
  def self.delegator_to_args(args)
    res = delegator_algorithm(args[:snapshot_id], args[:gid], args[:pid])
    ParamsToArgsHelper.calculate_per_snapshot_and_pin(res, args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.knowledge_distributor_to_args(args)
    res = knowledge_distributor_algorithm(args[:snapshot_id], args[:gid], args[:pid])
    ParamsToArgsHelper.calculate_per_snapshot_and_pin(res, args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.politically_active_to_args(args)
    res = politically_active_algorithm(args[:snapshot_id], args[:gid], args[:pid])
    ParamsToArgsHelper.calculate_per_snapshot_and_pin(res, args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.most_aloof_group_active_to_args(args)
    res = most_aloof_group_algorithm(args[:snapshot_id], args[:gid])
    return ParamsToArgsHelper.calculate_group_measure_scores(res)
  end
  ...
  def self.calculate_information_isolate_hidden_gauge(args)
    return AlgorithmsHelper.calculate_information_isolate_hidden_gauge(args[:snapshot_id], args[:network_id], args[:pid], args[:gid])
  end
  ...
  def self.calculate_representatives_flag(args)
    return AlgorithmsHelper.calculate_representatives_flag(args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.calculate_gate_keepers_for_flag(args)
    return AlgorithmsHelper.calculate_gate_keepers_for_flag(args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.calculate_bottlenecks_for_flag_to_explore(args)
    return AlgorithmsHelper.calculate_bottlenecks_for_flag_to_explore(args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.calculate_representatives_for_flag_to_explore(args)
    return AlgorithmsHelper.calculate_representatives_for_flag_to_explore(args[:snapshot_id], args[:pid], args[:gid])
  end
  ...
  def self.calculate_internal_faultlines_for_gender(args)
    return AlgorithmsHelper.calculate_internal_faultlines(args[:snapshot_id], args[:network_id], args[:network_b_id], args[:network_c_id], args[:pid], args[:gid], "gender")
  end

  def self.calculate_internal_faultlines_for_role(args)
    return AlgorithmsHelper.calculate_internal_faultlines(args[:snapshot_id], args[:network_id], args[:network_b_id], args[:network_c_id], args[:pid], args[:gid], "role_id")
  end

  def self.calculate_external_faultlines(args)
    return AlgorithmsHelper.calculate_external_faultlines(args[:snapshot_id], args[:network_id], args[:network_b_id], args[:network_c_id], args[:pid], args[:gid])
  end

  def self.calculate_internal_faultlines_for_office(args)
    return AlgorithmsHelper.calculate_internal_faultlines(args[:snapshot_id], args[:network_id], args[:network_b_id], args[:network_c_id], args[:pid], args[:gid], "office_id")
  end

  def self.calculate_non_reciprocity_between_employees_hidden_gauge(args)
    return AlgorithmsHelper.calculate_non_reciprocity_between_employees_hidden_gauge(args[:snapshot_id], args[:network_id], args[:network_b_id], args[:pid].to_i, args[:gid].to_i)
  end
  ...
  def self.trust_friendship_centrality(args)
    return AlgorithmsHelper.centrality_of_two_boolean_networks(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i, args[:network_id], args[:network_b_id])
  end

  def self.advice_email_centrality(args)
    return AlgorithmsHelper.centrality_of_emails_and_boolean_networks(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i, args[:network_id])
  end

  def self.advice_email_density(args)
    return AlgorithmsHelper.density_of_email_network(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i, args[:network_id])
  end

  ################# explore algorithms for metrics ########################
  ...
  def self.calculate_representatives_to_explore(args)
    return AlgorithmsHelper.calculate_representatives_to_explore(args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.calculate_gate_keepers_for_flag_explore(args)
    return AlgorithmsHelper.calculate_gate_keepers_for_flag_explore(args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.calculate_gate_keepers_for_explore(args)
    return AlgorithmsHelper.calculate_gate_keepers_for_explore(args[:snapshot_id], args[:pid], args[:gid])
  end
  ...
  def self.trust_friendship_centrality_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.advice_email_centrality_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.calculate_internal_faultlines_for_gender_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.calculate_internal_faultlines_for_role_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.calculate_internal_faultlines_for_office_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.advice_email_density_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.density_of_network_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.sinks_gauge(args)
    return AlgorithmsHelper.sinks_gauge(args[:snapshot_id], args[:pid], args[:gid])
  end

  def self.sinks_gauge_explore(args)
    return AlgorithmsHelper.sinks_gauge_explore(args[:snapshot_id], args[:pid], args[:gid])
  end
  ...
  def self.calculate_external_faultlines_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.calculate_embeddednes_of_emails_and_networks_explore(args)
    data = AlgorithmsHelper.assign_same_score_to_all_emps(args[:snapshot_id], args[:gid].to_i, args[:pid].to_i)
    return ParamsToArgsHelper.email_based_analyze_for_precalculation(data, args[:company_id].to_i, args[:pid].to_i, args[:gid].to_i)
  end

  def self.calculate_communication_dynamics(args)
    return AlgorithmsHelper.calculate_communication_dynamics(args[:gid].to_i, args[:snapshot_id].to_i)
  end
