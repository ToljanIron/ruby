...
Algorithm.find_or_create_by!(id: 709, name: 'external_receivers_measure', algorithm_type_id: 1, algorithm_flow_id: 2)
Algorithm.find_or_create_by!(id: 710, name: 'external_senders_measure', algorithm_type_id: 1, algorithm_flow_id: 2)

############## Meetings ####################
Algorithm.find_or_create_by!(id: 100, name: 'calculate_information_isolate_to_args', algorithm_type_id: 1, algorithm_flow_id: 1, meaningful_sqew: Algorithm::SCORE_SKEW_HIGH_IS_BAD)
...
Algorithm.find_or_create_by!(id: 101, name: 'calculate_powerful_non_managers_to_args', algorithm_type_id: 1, algorithm_flow_id: 1)
...
Algorithm.find_or_create_by!(id: 114, name: 'internal_champions', algorithm_type_id: 1, algorithm_flow_id: 2)
Algorithm.find_or_create_by!(id: 130, name: 'calculate_bottlenecks', algorithm_type_id: 1, algorithm_flow_id: 1, meaningful_sqew: Algorithm::SCORE_SKEW_HIGH_IS_BAD)
