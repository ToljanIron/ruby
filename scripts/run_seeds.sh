...
echo "Run seeds"
echo "======================="
RAILS_ENV=development rake db:seed:company db:seed:admin_user db:seed:algorithm_types db:seed:algorithms db:seed:colors db:seed:event_types db:seed:languages db:seed:ranks db:seed:configuration db:seed:age_group_and_seniority db:seed:marital_statuses db:seed:network_names

echo
echo "Create company metrics"
RAILS_ENV=development rake db:create_company_metrics_seed_to_cds\[1\]
